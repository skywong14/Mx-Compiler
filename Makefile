...
.PHONY: ir_single
ir_single:
	testcases/codegen/scripts/test_llvm_ir.bash 'java -cp /ulib/antlr-4.13.2-complete.jar:bin Main -emit-llvm' testcases/codegen/t75.mx src/IR/builtin/builtin.ll

...
.PHONY: singleIR
singleIR:
	testcases/codegen/scripts/test_llvm_ir.bash 'java -cp /ulib/antlr-4.13.2-complete.jar:bin Main -emit-llvm' testcases/codegen/shortest_path/dijkstra.mx src/IR/builtin/builtin.ll
